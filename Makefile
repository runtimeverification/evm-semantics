...
build-simple:
	...
	kompile --backend haskell evm-simple.k -I "/home/henry/evm-semantics-test/.build/usr/lib/kevm-simple/include/kframework" -I "/home/henry/evm-semantics-test/.build/usr/lib/kevm/blockchain-k-plugin/include/kframework" --hook-namespaces JSON KRYPTO --emit-json --directory ".build/usr/lib/kevm-simple/haskell" --main-module EVM --syntax-module EVM --debug
