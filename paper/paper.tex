...
\maketitle
\begin{abstract}
Ethereum smart contracts are everywhere. In this work, we model the EVM in K, a
language built specifically for extensible, formal verification of programming
languages.
\end{abstract}
% \input{abstract}
\input{introduction}
