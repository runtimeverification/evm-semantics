{
  ...
  inputs = {
    ...
    blockchain-k-plugin.url = "github:runtimeverification/blockchain-k-plugin/71aea50e6e9ceb94df89455b46ce83656ea3cff9";
    ...
    pyk.url = "github:runtimeverification/pyk/v0.1.316";
