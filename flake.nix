{
  ...
  inputs = {
    ...
    blockchain-k-plugin.url = "github:runtimeverification/blockchain-k-plugin/a80c2723768db165d2957e1217de21eb125f82ce";
    ...
    pyk.url = "github:runtimeverification/pyk/v0.1.319";
