{
  ...
  inputs = {
    nixpkgs.url = "github:NixOS/nixpkgs/nixpkgs-unstable/6b70761ea8c896aff8994eb367d9526686501860";
    k-framework.url = "github:runtimeverification/k/v5.6.45";
    ...
    pyk.url = "github:runtimeverification/pyk/v0.1.233";
