...
from .utils import (
    ...
    get_foundry_out_from_root,
    get_foundry_toml_profile,
...
class Foundry:
    ...
    def __init__(
        ...
        self._root = root
        self._toml_profile = get_foundry_toml_profile(root)
        self._out = root / Path(self._toml_profile['out'])
...
def foundry_kompile(
    ...
    foundry_out = get_foundry_out_from_root(foundry_root)
