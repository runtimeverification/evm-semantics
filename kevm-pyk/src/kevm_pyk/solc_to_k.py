...
class Contract:
    ...
    def macro_bin_runtime(self) -> KRule:
        if self.has_unlinked():
            raise AssertionError('Some library placeholders have been found. Please link the library(ies) first. Ref: https://docs.soliditylang.org/en/v0.8.20/using-the-compiler.html#library-linking')
        return KRule(
