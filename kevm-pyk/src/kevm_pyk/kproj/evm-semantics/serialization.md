...
```k
 ...
 // ---------------------------------------------------------------------------------
    ...
    syntax Account ::= #sender ( TxData , Int , Bytes , Bytes ) [function, symbol(#senderTxData)    ]
                     | #sender ( Bytes  , Int , Bytes , Bytes ) [function, symbol(#senderAux), total]
...
```k
    syntax Bytes ::= #hashSignedTx( Int , Int , Int , Account , Int , Bytes , Int , Bytes , Bytes ) [symbol(#hashSignedTx), function]
                   | #hashTxData  ( TxData )                                                        [symbol(#hashTxData), function]
 // ---------------------------------------------------------------------------------------------------------------------------------
...
```k
    syntax Int ::= #parseHexWord ( String ) [symbol(#parseHexWord), function]
                 | #parseWord    ( String ) [symbol(#parseWord), function]
 // -------------------------------------------------------------------------
    rule #parseHexWord("")   => 0
...
```k
 ...
 // --------------------------------------------------------------------------------------------------------
    ...
    syntax Bytes ::= #rlpEncodeReceipt ( Int , Int , Bytes , List ) [symbol(#rlpEncodeReceipt), function]
                   | #rlpEncodeLogs    ( List )                     [symbol(#rlpEncodeLogs), function]
                   | #rlpEncodeLogsAux ( List, StringBuffer )       [symbol(#rlpEncodeLogsAux), function]
                   | #rlpEncodeTopics  ( List, StringBuffer )       [symbol(#rlpEncodeTopics), function]
 // -----------------------------------------------------------------------------------------------------
