...
┣━━┓ subst: .Subst
┃  ┃ constraint:
┃  ┃     1023 <Int #sizeWordStack ( _WS:WordStack , 8 )
┃  │
┃  ├─ 3
┃  │   k: #next [ DUP ( 8 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
┃  ┃     ( notBool #sizeWordStack ( _WS:WordStack , 8 ) <Int 8 )
┃  ┃     ( notBool 1023 <Int #sizeWordStack ( _WS:WordStack , 8 ) )
┃  │
┃  ├─ 16
┃  │   k: #next [ DUP ( 8 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
    ...
    rule [BASIC-BLOCK-3-TO-8]: <kevm>
           ...
           <ethereum>
             <evm>
               ...
               <callState>
                 <wordStack>
                   ( __W0 : ( __W1 : ( __W2 : ( __W3 : ( __W4 : ( __W5 : ( __W6 : ( __W7 : _WS:WordStack ) ) ) ) ) ) ) )
                 </wordStack>
                 ...
               </callState>
               ...
      ...
      requires 1023 <Int #sizeWordStack ( _WS:WordStack , 8 )
    ...
    rule [BASIC-BLOCK-16-TO-13]: <kevm>
           ...
           <ethereum>
             <evm>
               <callState>
                 <wordStack>
                   ( ( _W0:Int => _W7:Int ) : ( ( _W1:Int => _W0:Int ) : ( ( _W2:Int => _W1:Int ) : ( ( _W3:Int => _W2:Int ) : ( ( _W4:Int => _W3:Int ) : ( ( _W5:Int => _W4:Int ) : ( ( _W6:Int => _W5:Int ) : ( ( _W7:Int => _W6:Int ) : ( _WS:WordStack => ( _W7:Int : _WS:WordStack ) ) ) ) ) ) ) ) ) )
                 </wordStack>
                 <pc>
      ...
      requires ( ( notBool _USEGAS_CELL:Bool )
       andBool ( ( notBool #sizeWordStack ( _WS:WordStack , 8 ) <Int 8 )
       andBool ( ( notBool 1023 <Int #sizeWordStack ( _WS:WordStack , 8 ) )
               )))
       ensures #sizeWordStack ( _WS:WordStack , 8 ) <=Int 1023
