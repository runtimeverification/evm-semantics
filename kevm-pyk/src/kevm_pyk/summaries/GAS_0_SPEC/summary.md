    ...
    rule [BASIC-BLOCK-16-TO-13]: <kevm>
           ...
           <ethereum>
             <evm>
               <callState>
                 <wordStack>
                   ( _WS:WordStack => ( gas2Int ( _GAS_CELL:Gas ) : _WS:WordStack ) )
                 </wordStack>
                 <pc>
    ...
    rule [BASIC-BLOCK-19-TO-14]: <kevm>
           ...
           <ethereum>
             <evm>
               <callState>
                 <wordStack>
                   ( _WS:WordStack => ( gas2Int ( _GAS_CELL:Gas -Gas Gbase < _SCHEDULE_CELL:Schedule > ) : _WS:WordStack ) )
                 </wordStack>
                 <pc>
                   ( _PC_CELL:Int => ( _PC_CELL:Int +Int 1 ) )
                 </pc>
