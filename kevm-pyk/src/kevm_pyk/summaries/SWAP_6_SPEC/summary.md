...
┣━━┓ subst: .Subst
┃  ┃ constraint:
┃  ┃     #sizeWordStack ( _WS:WordStack , 6 ) <Int 7
┃  │
┃  ├─ 3
┃  │   k: #next [ SWAP ( 6 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
┃  ┃     7 <=Int #sizeWordStack ( _WS:WordStack , 6 )
┃  │
┃  ├─ 16
┃  │   k: #next [ SWAP ( 6 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
module SUMMARY-SWAP-6-SPEC
    ...
    rule [BASIC-BLOCK-3-TO-8]: <kevm>
      ...
      requires #sizeWordStack ( _WS:WordStack , 6 ) <Int 7
    ...
    rule [BASIC-BLOCK-16-TO-13]: <kevm>
           ...
           <ethereum>
             <evm>
               <callState>
                 <wordStack>
                   ( ( _W0:Int => _WS:WordStack [ 0 ] ) : ( __W1 : ( __W2 : ( __W3 : ( __W4 : ( __W5 : ( _WS:WordStack => _WS:WordStack [ 0 := _W0:Int ] ) ) ) ) ) ) )
                 </wordStack>
                 <pc>
      ...
      requires ( ( notBool _USEGAS_CELL:Bool )
       andBool ( 7 <=Int #sizeWordStack ( _WS:WordStack , 6 )
               ))
