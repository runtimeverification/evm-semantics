...
┣━━┓ subst: .Subst
┃  ┃ constraint:
┃  ┃     #sizeWordStack ( _WS:WordStack , 15 ) <Int 16
┃  │
┃  ├─ 3
┃  │   k: #next [ SWAP ( 15 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
┃  ┃     16 <=Int #sizeWordStack ( _WS:WordStack , 15 )
┃  │
┃  ├─ 16
┃  │   k: #next [ SWAP ( 15 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
module SUMMARY-SWAP-15-SPEC
    ...
    rule [BASIC-BLOCK-3-TO-8]: <kevm>
      ...
      requires #sizeWordStack ( _WS:WordStack , 15 ) <Int 16
    ...
    rule [BASIC-BLOCK-16-TO-13]: <kevm>
           ...
           <ethereum>
             <evm>
               <callState>
                 <wordStack>
                   ( ( _W0:Int => _WS:WordStack [ 0 ] ) : ( __W1 : ( __W2 : ( __W3 : ( __W4 : ( __W5 : ( __W6 : ( __W7 : ( __W8 : ( __W9 : ( __W10 : ( __W11 : ( __W12 : ( __W13 : ( __W14 : ( _WS:WordStack => _WS:WordStack [ 0 := _W0:Int ] ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
                 </wordStack>
                 <pc>
      ...
      requires ( ( notBool _USEGAS_CELL:Bool )
       andBool ( 16 <=Int #sizeWordStack ( _WS:WordStack , 15 )
               ))
