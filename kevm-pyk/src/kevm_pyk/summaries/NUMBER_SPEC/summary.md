...
┃  │  (7 steps)
┃  ├─ 11
┃  │   k: Gbase < _SCHEDULE_CELL:Schedule > ~> #deductGas ~> #access [ NUMBER , NUMBER ] ~ ...
┃  │   pc: _PC_CELL:Int
┃  │   callDepth: _CALLDEPTH_CELL:Int
┃  │   statusCode: _STATUSCODE_CELL:StatusCode
┃  ┃
...
┃  ┃  │
┃  ┃  └─ 12 (leaf, pending)
┃  ┃      k: #access [ NUMBER , NUMBER ] ~> NUMBER ~> #pc [ NUMBER ] ~> _K_CELL:K
┃  ┃      pc: _PC_CELL:Int
┃  ┃      callDepth: _CALLDEPTH_CELL:Int
┃  ┃      statusCode: _STATUSCODE_CELL:StatusCode
┃  ┃
...
┃  ┃  │
┃  ┃  ├─ 13
┃  ┃  │   k: #end EVMC_OUT_OF_GAS ~> #access [ NUMBER , NUMBER ] ~> NUMBER ~> #pc [ NUMBER ]  ...
┃  ┃  │   pc: _PC_CELL:Int
┃  ┃  │   callDepth: _CALLDEPTH_CELL:Int
┃  ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
┃  ┃  │
...
┗━━┓ subst: .Subst
   ...
   │  (3 steps)
   └─ 10 (leaf, pending)
       k: #gas [ NUMBER , NUMBER ] ~> NUMBER ~> #pc [ NUMBER ] ~> _K_CELL:K
       pc: _PC_CELL:Int
       callDepth: _CALLDEPTH_CELL:Int
       statusCode: _STATUSCODE_CELL:StatusCode
...
module SUMMARY-NUMBER-SPEC
    ...
    rule [BASIC-BLOCK-17-TO-10]: <kevm>
           <k>
             ( #next [ NUMBER ] ~> .K => #gas [ NUMBER , NUMBER ]
             ~> NUMBER
             ~> #pc [ NUMBER ] )
             ~> __K_CELL
           </k>
    ...
    rule [BASIC-BLOCK-16-TO-11]: <kevm>
           <k>
             ( #next [ NUMBER ] ~> .K => Gbase < _SCHEDULE_CELL:Schedule >
             ~> #deductGas
             ~> #access [ NUMBER , NUMBER ]
             ~> NUMBER
             ~> #pc [ NUMBER ] )
