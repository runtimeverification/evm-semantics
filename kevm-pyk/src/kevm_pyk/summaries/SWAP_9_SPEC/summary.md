...
┣━━┓ subst: .Subst
┃  ┃ constraint:
┃  ┃     #sizeWordStack ( _WS:WordStack , 9 ) <Int 10
┃  │
┃  ├─ 3
┃  │   k: #next [ SWAP ( 9 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
┃  ┃     10 <=Int #sizeWordStack ( _WS:WordStack , 9 )
┃  │
┃  ├─ 16
┃  │   k: #next [ SWAP ( 9 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
module SUMMARY-SWAP-9-SPEC
    ...
    rule [BASIC-BLOCK-3-TO-6]: <kevm>
      ...
      requires #sizeWordStack ( _WS:WordStack , 9 ) <Int 10
    ...
    rule [BASIC-BLOCK-16-TO-13]: <kevm>
           ...
           <ethereum>
             <evm>
               <callState>
                 <wordStack>
                   ( ( _W0:Int => _WS:WordStack [ 0 ] ) : ( __W1 : ( __W2 : ( __W3 : ( __W4 : ( __W5 : ( __W6 : ( __W7 : ( __W8 : ( _WS:WordStack => _WS:WordStack [ 0 := _W0:Int ] ) ) ) ) ) ) ) ) ) )
                 </wordStack>
                 <pc>
      ...
      requires ( ( notBool _USEGAS_CELL:Bool )
       andBool ( 10 <=Int #sizeWordStack ( _WS:WordStack , 9 )
               ))
