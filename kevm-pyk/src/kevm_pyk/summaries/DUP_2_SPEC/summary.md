...
┣━━┓ subst: .Subst
┃  ┃ constraint:
┃  ┃     1023 <Int #sizeWordStack ( _WS:WordStack , 2 )
┃  │
┃  ├─ 3
┃  │   k: #next [ DUP ( 2 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
┃  ┃     ( notBool #sizeWordStack ( _WS:WordStack , 2 ) <Int 2 )
┃  ┃     ( notBool 1023 <Int #sizeWordStack ( _WS:WordStack , 2 ) )
┃  │
┃  ├─ 16
┃  │   k: #next [ DUP ( 2 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
module SUMMARY-DUP-2-SPEC
    ...
    rule [BASIC-BLOCK-3-TO-8]: <kevm>
      ...
      requires 1023 <Int #sizeWordStack ( _WS:WordStack , 2 )
    ...
    rule [BASIC-BLOCK-16-TO-13]: <kevm>
           ...
           <ethereum>
             <evm>
               <callState>
                 <wordStack>
                   ( ( _W0:Int => _W1:Int ) : ( ( _W1:Int => _W0:Int ) : ( _WS:WordStack => ( _W1:Int : _WS:WordStack ) ) ) )
                 </wordStack>
                 <pc>
      ...
      requires ( ( notBool _USEGAS_CELL:Bool )
       andBool ( ( notBool #sizeWordStack ( _WS:WordStack , 2 ) <Int 2 )
       andBool ( ( notBool 1023 <Int #sizeWordStack ( _WS:WordStack , 2 ) )
               )))
       ensures #sizeWordStack ( _WS:WordStack , 2 ) <=Int 1023
