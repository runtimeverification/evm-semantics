...
┃  │  (7 steps)
┃  ├─ 14
┃  │   k: Gbase < _SCHEDULE_CELL:Schedule > ~> #deductGas ~> #access [ ORIGIN , ORIGIN ] ~ ...
┃  │   pc: _PC_CELL:Int
┃  │   callDepth: _CALLDEPTH_CELL:Int
┃  │   statusCode: _STATUSCODE_CELL:StatusCode
┃  ┃
...
┃  ┃  │
┃  ┃  ├─ 15
┃  ┃  │   k: #access [ ORIGIN , ORIGIN ] ~> ORIGIN ~> #pc [ ORIGIN ] ~> _K_CELL:K
┃  ┃  │   pc: _PC_CELL:Int
┃  ┃  │   callDepth: _CALLDEPTH_CELL:Int
┃  ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
┃  ┃  │
...
┃  ┃  │
┃  ┃  ├─ 16
┃  ┃  │   k: #end EVMC_OUT_OF_GAS ~> #access [ ORIGIN , ORIGIN ] ~> ORIGIN ~> #pc [ ORIGIN ]  ...
┃  ┃  │   pc: _PC_CELL:Int
┃  ┃  │   callDepth: _CALLDEPTH_CELL:Int
┃  ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
┃  ┃  │
...
module SUMMARY-ORIGIN-SPEC
    ...
    rule [BASIC-BLOCK-22-TO-14]: <kevm>
           <k>
             ( #next [ ORIGIN ] ~> .K => Gbase < _SCHEDULE_CELL:Schedule >
             ~> #deductGas
             ~> #access [ ORIGIN , ORIGIN ]
             ~> ORIGIN
             ~> #pc [ ORIGIN ] )
