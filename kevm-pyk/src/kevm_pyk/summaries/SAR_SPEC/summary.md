...
┗━━┓ subst: .Subst
   ...
   ┃  │
   ┃  ├─ 9 (split)
   ┃  │   k: #gas [ SAR , SAR W0:Int W1:Int ] ~> SAR W0:Int W1:Int ~> #pc [ SAR ] ~> _K_CELL: ...
   ┃  │   pc: _PC_CELL:Int
   ┃  │   callDepth: _CALLDEPTH_CELL:Int
   ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
   ┃  ┃
   ...
   ┃  ┃  │  (4 steps)
   ┃  ┃  ├─ 17
   ┃  ┃  │   k: Gverylow < _SCHEDULE_CELL:Schedule > ~> #deductGas ~> #access [ SAR , SAR W0:Int ...
   ┃  ┃  │   pc: _PC_CELL:Int
   ┃  ┃  │   callDepth: _CALLDEPTH_CELL:Int
   ┃  ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
   ┃  ┃  ┃
   ...
   ┃  ┃  ┃  │
   ┃  ┃  ┃  └─ 20 (leaf, pending)
   ┃  ┃  ┃      k: #access [ SAR , SAR W0:Int W1:Int ] ~> SAR W0:Int W1:Int ~> #pc [ SAR ] ~> _K_CE ...
   ┃  ┃  ┃      pc: _PC_CELL:Int
   ┃  ┃  ┃      callDepth: _CALLDEPTH_CELL:Int
   ┃  ┃  ┃      statusCode: _STATUSCODE_CELL:StatusCode
   ┃  ┃  ┃
   ...
   ┃  ┃  ┃  │
   ┃  ┃  ┃  ├─ 21
   ┃  ┃  ┃  │   k: #end EVMC_OUT_OF_GAS ~> #access [ SAR , SAR W0:Int W1:Int ] ~> SAR W0:Int W1:Int ...
   ┃  ┃  ┃  │   pc: _PC_CELL:Int
   ┃  ┃  ┃  │   callDepth: _CALLDEPTH_CELL:Int
   ┃  ┃  ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
   ┃  ┃  ┃  │
   ...
   ┗━━┓
      ...
      ┃  │
      ┃  ├─ 13 (split)
      ┃  │   k: #gas [ SAR , SAR W0:Int W2:Int ] ~> SAR W0:Int W2:Int ~> #pc [ SAR ] ~> _K_CELL: ...
      ┃  │   pc: _PC_CELL:Int
      ┃  │   callDepth: _CALLDEPTH_CELL:Int
      ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
      ┃  ┃
      ...
      ┗━━┓
         ...
         ┃  │
         ┃  ├─ 18 (split)
         ┃  │   k: #gas [ SAR , SAR W0:Int W3:Int ] ~> SAR W0:Int W3:Int ~> #pc [ SAR ] ~> _K_CELL: ...
         ┃  │   pc: _PC_CELL:Int
         ┃  │   callDepth: _CALLDEPTH_CELL:Int
         ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
         ┃  ┃
         ...
         ┗━━┓
            ...
            ┃  │
            ┃  └─ 25 (leaf, pending)
            ┃      k: #gas [ SAR , SAR W0:Int W4:Int ] ~> SAR W0:Int W4:Int ~> #pc [ SAR ] ~> _K_CELL: ...
            ┃      pc: _PC_CELL:Int
            ┃      callDepth: _CALLDEPTH_CELL:Int
            ┃      statusCode: _STATUSCODE_CELL:StatusCode
            ┃
...
module SUMMARY-SAR-SPEC
    ...
    rule [BASIC-BLOCK-11-TO-17]: <kevm>
           <k>
             ( #gas [ SAR , SAR W0:Int W1:Int ] ~> .K => Gverylow < _SCHEDULE_CELL:Schedule >
             ~> #deductGas
             ~> #access [ SAR , SAR W0:Int W1:Int ] )
             ~> SAR W0:Int W1:Int
             ~> #pc [ SAR ]
             ~> __K_CELL
           </k>
    ...
    rule [BASIC-BLOCK-15-TO-27]: <kevm>
           <k>
             ( #gas [ SAR , SAR W0:Int W2:Int ] ~> .K => Gverylow < _SCHEDULE_CELL:Schedule >
             ~> #deductGas
             ~> #access [ SAR , SAR W0:Int W2:Int ] )
             ~> SAR W0:Int W2:Int
             ~> #pc [ SAR ]
             ~> __K_CELL
           </k>
    ...
    rule [BASIC-BLOCK-21-TO-28]: <kevm>
           <k>
             ( #end EVMC_OUT_OF_GAS
             ~> #access [ SAR , SAR W0:Int W1:Int ]
             ~> SAR W0:Int W1:Int
      ...
      [priority(20), label(BASIC-BLOCK-21-TO-28)]
