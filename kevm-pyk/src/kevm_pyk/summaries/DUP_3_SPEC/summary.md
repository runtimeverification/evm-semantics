...
┣━━┓ subst: .Subst
┃  ┃ constraint:
┃  ┃     1023 <Int #sizeWordStack ( _WS:WordStack , 3 )
┃  │
┃  ├─ 3
┃  │   k: #next [ DUP ( 3 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
┃  ┃     ( notBool #sizeWordStack ( _WS:WordStack , 3 ) <Int 3 )
┃  ┃     ( notBool 1023 <Int #sizeWordStack ( _WS:WordStack , 3 ) )
┃  │
┃  ├─ 16
┃  │   k: #next [ DUP ( 3 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
module SUMMARY-DUP-3-SPEC
    ...
    rule [BASIC-BLOCK-3-TO-8]: <kevm>
      ...
      requires 1023 <Int #sizeWordStack ( _WS:WordStack , 3 )
    ...
    rule [BASIC-BLOCK-16-TO-13]: <kevm>
           ...
           <ethereum>
             <evm>
               <callState>
                 <wordStack>
                   ( ( _W0:Int => _W2:Int ) : ( ( _W1:Int => _W0:Int ) : ( ( _W2:Int => _W1:Int ) : ( _WS:WordStack => ( _W2:Int : _WS:WordStack ) ) ) ) )
                 </wordStack>
                 <pc>
      ...
      requires ( ( notBool _USEGAS_CELL:Bool )
       andBool ( ( notBool #sizeWordStack ( _WS:WordStack , 3 ) <Int 3 )
       andBool ( ( notBool 1023 <Int #sizeWordStack ( _WS:WordStack , 3 ) )
               )))
       ensures #sizeWordStack ( _WS:WordStack , 3 ) <=Int 1023
