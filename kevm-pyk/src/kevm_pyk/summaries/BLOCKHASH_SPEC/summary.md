...
┗━━┓ subst: .Subst
   ...
   │  (2 steps)
   ├─ 6
   │   k: #exec [ BLOCKHASH ] ~> #pc [ BLOCKHASH ] ~> _K_CELL:K
   │   pc: _PC_CELL:Int
   │   callDepth: _CALLDEPTH_CELL:Int
   │   statusCode: _STATUSCODE_CELL:StatusCode
   ┃
   ...
   ┃  │
   ┃  ├─ 9 (split)
   ┃  │   k: #gas [ BLOCKHASH , BLOCKHASH W0:Int ] ~> BLOCKHASH W0:Int ~> #pc [ BLOCKHASH ] ~ ...
   ┃  │   pc: _PC_CELL:Int
   ┃  │   callDepth: _CALLDEPTH_CELL:Int
   ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
   ┃  ┃
   ...
   ┃  ┃  │  (4 steps)
   ┃  ┃  ├─ 19
   ┃  ┃  │   k: Gblockhash < _SCHEDULE_CELL:Schedule > ~> #deductGas ~> #access [ BLOCKHASH , BL ...
   ┃  ┃  │   pc: _PC_CELL:Int
   ┃  ┃  │   callDepth: _CALLDEPTH_CELL:Int
   ┃  ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
   ┃  ┃  ┃
   ...
   ┃  ┃  ┃  │
   ┃  ┃  ┃  └─ 20 (leaf, pending)
   ┃  ┃  ┃      k: #access [ BLOCKHASH , BLOCKHASH W0:Int ] ~> BLOCKHASH W0:Int ~> #pc [ BLOCKHASH  ...
   ┃  ┃  ┃      pc: _PC_CELL:Int
   ┃  ┃  ┃      callDepth: _CALLDEPTH_CELL:Int
   ┃  ┃  ┃      statusCode: _STATUSCODE_CELL:StatusCode
   ┃  ┃  ┃
   ...
   ┃  ┃  ┃  │
   ┃  ┃  ┃  ├─ 21
   ┃  ┃  ┃  │   k: #end EVMC_OUT_OF_GAS ~> #access [ BLOCKHASH , BLOCKHASH W0:Int ] ~> BLOCKHASH W0 ...
   ┃  ┃  ┃  │   pc: _PC_CELL:Int
   ┃  ┃  ┃  │   callDepth: _CALLDEPTH_CELL:Int
   ┃  ┃  ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
   ┃  ┃  ┃  │
...
module SUMMARY-BLOCKHASH-SPEC
    
    
    rule [BASIC-BLOCK-5-TO-6]: <kevm>
           <k>
             ( #next [ BLOCKHASH ] ~> .K => #exec [ BLOCKHASH ]
             ~> #pc [ BLOCKHASH ] )
             ~> __K_CELL
           </k>
           <ethereum>
    ...
    rule [BASIC-BLOCK-11-TO-19]: <kevm>
           <k>
             ( #gas [ BLOCKHASH , BLOCKHASH W0:Int ] ~> .K => Gblockhash < _SCHEDULE_CELL:Schedule >
             ~> #deductGas
             ~> #access [ BLOCKHASH , BLOCKHASH W0:Int ] )
             ~> BLOCKHASH W0:Int
             ~> #pc [ BLOCKHASH ]
             ~> __K_CELL
           </k>
