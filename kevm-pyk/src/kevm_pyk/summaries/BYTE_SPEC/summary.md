...
┗━━┓ subst: .Subst
   ...
   ┃  │
   ┃  ├─ 9 (split)
   ┃  │   k: #gas [ BYTE , BYTE W0:Int W1:Int ] ~> BYTE W0:Int W1:Int ~> #pc [ BYTE ] ~> _K_C ...
   ┃  │   pc: _PC_CELL:Int
   ┃  │   callDepth: _CALLDEPTH_CELL:Int
   ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
   ┃  ┃
   ...
   ┃  ┃  │  (4 steps)
   ┃  ┃  ├─ 19
   ┃  ┃  │   k: Gverylow < _SCHEDULE_CELL:Schedule > ~> #deductGas ~> #access [ BYTE , BYTE W0:I ...
   ┃  ┃  │   pc: _PC_CELL:Int
   ┃  ┃  │   callDepth: _CALLDEPTH_CELL:Int
   ┃  ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
   ┃  ┃  ┃
   ...
   ┃  ┃  ┃  │
   ┃  ┃  ┃  └─ 20 (leaf, pending)
   ┃  ┃  ┃      k: #access [ BYTE , BYTE W0:Int W1:Int ] ~> BYTE W0:Int W1:Int ~> #pc [ BYTE ] ~> _ ...
   ┃  ┃  ┃      pc: _PC_CELL:Int
   ┃  ┃  ┃      callDepth: _CALLDEPTH_CELL:Int
   ┃  ┃  ┃      statusCode: _STATUSCODE_CELL:StatusCode
   ┃  ┃  ┃
   ...
   ┃  ┃  ┃  │
   ┃  ┃  ┃  └─ 21 (leaf, pending)
   ┃  ┃  ┃      k: #end EVMC_OUT_OF_GAS ~> #access [ BYTE , BYTE W0:Int W1:Int ] ~> BYTE W0:Int W1: ...
   ┃  ┃  ┃      pc: _PC_CELL:Int
   ┃  ┃  ┃      callDepth: _CALLDEPTH_CELL:Int
   ┃  ┃  ┃      statusCode: _STATUSCODE_CELL:StatusCode
   ┃  ┃  ┃
   ...
   ┗━━┓
      ...
      ┃  │
      ┃  ├─ 13 (split)
      ┃  │   k: #gas [ BYTE , BYTE W0:Int W2:Int ] ~> BYTE W0:Int W2:Int ~> #pc [ BYTE ] ~> _K_C ...
      ┃  │   pc: _PC_CELL:Int
      ┃  │   callDepth: _CALLDEPTH_CELL:Int
      ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
      ┃  ┃
      ...
      ┗━━┓
         ...
         ┃  │
         ┃  ├─ 17 (split)
         ┃  │   k: #gas [ BYTE , BYTE W0:Int W3:Int ] ~> BYTE W0:Int W3:Int ~> #pc [ BYTE ] ~> _K_C ...
         ┃  │   pc: _PC_CELL:Int
         ┃  │   callDepth: _CALLDEPTH_CELL:Int
         ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
         ┃  ┃
         ...
         ┗━━┓
            ...
            ┃  │
            ┃  └─ 25 (leaf, pending)
            ┃      k: #gas [ BYTE , BYTE W0:Int W4:Int ] ~> BYTE W0:Int W4:Int ~> #pc [ BYTE ] ~> _K_C ...
            ┃      pc: _PC_CELL:Int
            ┃      callDepth: _CALLDEPTH_CELL:Int
            ┃      statusCode: _STATUSCODE_CELL:StatusCode
            ┃
...
module SUMMARY-BYTE-SPEC
    
    
    rule [BASIC-BLOCK-5-TO-6]: <kevm>
           <k>
             ( #next [ BYTE ] ~> .K => #exec [ BYTE ]
             ~> #pc [ BYTE ] )
             ~> __K_CELL
           </k>
           <ethereum>
    ...
    rule [BASIC-BLOCK-11-TO-19]: <kevm>
           <k>
             ( #gas [ BYTE , BYTE W0:Int W1:Int ] ~> .K => Gverylow < _SCHEDULE_CELL:Schedule >
             ~> #deductGas
             ~> #access [ BYTE , BYTE W0:Int W1:Int ] )
             ~> BYTE W0:Int W1:Int
             ~> #pc [ BYTE ]
             ~> __K_CELL
           </k>
    ...
    rule [BASIC-BLOCK-15-TO-27]: <kevm>
           <k>
             ( #gas [ BYTE , BYTE W0:Int W2:Int ] ~> .K => Gverylow < _SCHEDULE_CELL:Schedule >
             ~> #deductGas
             ~> #access [ BYTE , BYTE W0:Int W2:Int ] )
             ~> BYTE W0:Int W2:Int
             ~> #pc [ BYTE ]
             ~> __K_CELL
           </k>
