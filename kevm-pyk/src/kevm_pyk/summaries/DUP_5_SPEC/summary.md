...
┣━━┓ subst: .Subst
┃  ┃ constraint:
┃  ┃     1023 <Int #sizeWordStack ( _WS:WordStack , 5 )
┃  │
┃  ├─ 3
┃  │   k: #next [ DUP ( 5 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
┃  ┃     ( notBool #sizeWordStack ( _WS:WordStack , 5 ) <Int 5 )
┃  ┃     ( notBool 1023 <Int #sizeWordStack ( _WS:WordStack , 5 ) )
┃  │
┃  ├─ 16
┃  │   k: #next [ DUP ( 5 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
module SUMMARY-DUP-5-SPEC
    ...
    rule [BASIC-BLOCK-3-TO-8]: <kevm>
      ...
      requires 1023 <Int #sizeWordStack ( _WS:WordStack , 5 )
    ...
    rule [BASIC-BLOCK-16-TO-13]: <kevm>
           ...
           <ethereum>
             <evm>
               <callState>
                 <wordStack>
                   ( ( _W0:Int => _W4:Int ) : ( ( _W1:Int => _W0:Int ) : ( ( _W2:Int => _W1:Int ) : ( ( _W3:Int => _W2:Int ) : ( ( _W4:Int => _W3:Int ) : ( _WS:WordStack => ( _W4:Int : _WS:WordStack ) ) ) ) ) ) )
                 </wordStack>
                 <pc>
      ...
      requires ( ( notBool _USEGAS_CELL:Bool )
       andBool ( ( notBool #sizeWordStack ( _WS:WordStack , 5 ) <Int 5 )
       andBool ( ( notBool 1023 <Int #sizeWordStack ( _WS:WordStack , 5 ) )
               )))
       ensures #sizeWordStack ( _WS:WordStack , 5 ) <=Int 1023
