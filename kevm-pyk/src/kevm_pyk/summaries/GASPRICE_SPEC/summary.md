...
┃  │  (7 steps)
┃  ├─ 11
┃  │   k: Gbase < _SCHEDULE_CELL:Schedule > ~> #deductGas ~> #access [ GASPRICE , GASPRICE ...
┃  │   pc: _PC_CELL:Int
┃  │   callDepth: _CALLDEPTH_CELL:Int
┃  │   statusCode: _STATUSCODE_CELL:StatusCode
┃  ┃
...
┃  ┃  │
┃  ┃  └─ 12 (leaf, pending)
┃  ┃      k: #access [ GASPRICE , GASPRICE ] ~> GASPRICE ~> #pc [ GASPRICE ] ~> _K_CELL:K
┃  ┃      pc: _PC_CELL:Int
┃  ┃      callDepth: _CALLDEPTH_CELL:Int
┃  ┃      statusCode: _STATUSCODE_CELL:StatusCode
┃  ┃
...
┃  ┃  │
┃  ┃  ├─ 13
┃  ┃  │   k: #end EVMC_OUT_OF_GAS ~> #access [ GASPRICE , GASPRICE ] ~> GASPRICE ~> #pc [ GAS ...
┃  ┃  │   pc: _PC_CELL:Int
┃  ┃  │   callDepth: _CALLDEPTH_CELL:Int
┃  ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
┃  ┃  │
...
┗━━┓ subst: .Subst
   ...
   │  (3 steps)
   └─ 10 (leaf, pending)
       k: #gas [ GASPRICE , GASPRICE ] ~> GASPRICE ~> #pc [ GASPRICE ] ~> _K_CELL:K
       pc: _PC_CELL:Int
       callDepth: _CALLDEPTH_CELL:Int
       statusCode: _STATUSCODE_CELL:StatusCode
...
module SUMMARY-GASPRICE-SPEC
    ...
    rule [BASIC-BLOCK-17-TO-10]: <kevm>
           <k>
             ( #next [ GASPRICE ] ~> .K => #gas [ GASPRICE , GASPRICE ]
             ~> GASPRICE
             ~> #pc [ GASPRICE ] )
             ~> __K_CELL
           </k>
    ...
    rule [BASIC-BLOCK-16-TO-11]: <kevm>
           <k>
             ( #next [ GASPRICE ] ~> .K => Gbase < _SCHEDULE_CELL:Schedule >
             ~> #deductGas
             ~> #access [ GASPRICE , GASPRICE ]
             ~> GASPRICE
             ~> #pc [ GASPRICE ] )
