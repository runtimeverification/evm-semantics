...
┣━━┓ subst: .Subst
┃  ┃ constraint:
┃  ┃     1023 <Int #sizeWordStack ( _WS:WordStack , 13 )
┃  │
┃  ├─ 3
┃  │   k: #next [ DUP ( 13 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
┃  ┃     ( notBool #sizeWordStack ( _WS:WordStack , 13 ) <Int 13 )
┃  ┃     ( notBool 1023 <Int #sizeWordStack ( _WS:WordStack , 13 ) )
┃  │
┃  ├─ 16
┃  │   k: #next [ DUP ( 13 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
module SUMMARY-DUP-13-SPEC
    ...
    rule [BASIC-BLOCK-3-TO-6]: <kevm>
      ...
      requires 1023 <Int #sizeWordStack ( _WS:WordStack , 13 )
    ...
    rule [BASIC-BLOCK-16-TO-13]: <kevm>
           ...
           <ethereum>
             <evm>
               <callState>
                 <wordStack>
                   ( ( _W0:Int => _W12:Int ) : ( ( _W1:Int => _W0:Int ) : ( ( _W2:Int => _W1:Int ) : ( ( _W3:Int => _W2:Int ) : ( ( _W4:Int => _W3:Int ) : ( ( _W5:Int => _W4:Int ) : ( ( _W6:Int => _W5:Int ) : ( ( _W7:Int => _W6:Int ) : ( ( _W8:Int => _W7:Int ) : ( ( _W9:Int => _W8:Int ) : ( ( _W10:Int => _W9:Int ) : ( ( _W11:Int => _W10:Int ) : ( ( _W12:Int => _W11:Int ) : ( _WS:WordStack => ( _W12:Int : _WS:WordStack ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
                 </wordStack>
                 <pc>
      ...
      requires ( ( notBool _USEGAS_CELL:Bool )
       andBool ( ( notBool #sizeWordStack ( _WS:WordStack , 13 ) <Int 13 )
       andBool ( ( notBool 1023 <Int #sizeWordStack ( _WS:WordStack , 13 ) )
               )))
       ensures #sizeWordStack ( _WS:WordStack , 13 ) <=Int 1023
