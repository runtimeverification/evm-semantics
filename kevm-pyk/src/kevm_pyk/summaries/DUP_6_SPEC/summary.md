...
┣━━┓ subst: .Subst
┃  ┃ constraint:
┃  ┃     1023 <Int #sizeWordStack ( _WS:WordStack , 6 )
┃  │
┃  ├─ 3
┃  │   k: #next [ DUP ( 6 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
┃  ┃     ( notBool #sizeWordStack ( _WS:WordStack , 6 ) <Int 6 )
┃  ┃     ( notBool 1023 <Int #sizeWordStack ( _WS:WordStack , 6 ) )
┃  │
┃  ├─ 16
┃  │   k: #next [ DUP ( 6 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
    ...
    rule [BASIC-BLOCK-3-TO-6]: <kevm>
           ...
           <ethereum>
             <evm>
               ...
               <callState>
                 <wordStack>
                   ( __W0 : ( __W1 : ( __W2 : ( __W3 : ( __W4 : ( __W5 : _WS:WordStack ) ) ) ) ) )
                 </wordStack>
                 ...
               </callState>
               ...
      ...
      requires 1023 <Int #sizeWordStack ( _WS:WordStack , 6 )
    ...
    rule [BASIC-BLOCK-16-TO-13]: <kevm>
           ...
           <ethereum>
             <evm>
               <callState>
                 <wordStack>
                   ( ( _W0:Int => _W5:Int ) : ( ( _W1:Int => _W0:Int ) : ( ( _W2:Int => _W1:Int ) : ( ( _W3:Int => _W2:Int ) : ( ( _W4:Int => _W3:Int ) : ( ( _W5:Int => _W4:Int ) : ( _WS:WordStack => ( _W5:Int : _WS:WordStack ) ) ) ) ) ) ) )
                 </wordStack>
                 <pc>
      ...
      requires ( ( notBool _USEGAS_CELL:Bool )
       andBool ( ( notBool #sizeWordStack ( _WS:WordStack , 6 ) <Int 6 )
       andBool ( ( notBool 1023 <Int #sizeWordStack ( _WS:WordStack , 6 ) )
               )))
       ensures #sizeWordStack ( _WS:WordStack , 6 ) <=Int 1023
