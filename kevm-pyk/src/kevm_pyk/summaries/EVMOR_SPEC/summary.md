...
┗━━┓ subst: .Subst
   ...
   │  (2 steps)
   ├─ 6
   │   k: #exec [ EVMOR ] ~> #pc [ EVMOR ] ~> _K_CELL:K
   │   pc: _PC_CELL:Int
   │   callDepth: _CALLDEPTH_CELL:Int
   │   statusCode: _STATUSCODE_CELL:StatusCode
   ┃
   ...
   ┃  │
   ┃  ├─ 9 (split)
   ┃  │   k: #gas [ EVMOR , EVMOR W0:Int W1:Int ] ~> EVMOR W0:Int W1:Int ~> #pc [ EVMOR ] ~>  ...
   ┃  │   pc: _PC_CELL:Int
   ┃  │   callDepth: _CALLDEPTH_CELL:Int
   ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
   ┃  ┃
   ...
   ┃  ┃  │  (4 steps)
   ┃  ┃  ├─ 17
   ┃  ┃  │   k: Gverylow < _SCHEDULE_CELL:Schedule > ~> #deductGas ~> #access [ EVMOR , EVMOR W0 ...
   ┃  ┃  │   pc: _PC_CELL:Int
   ┃  ┃  │   callDepth: _CALLDEPTH_CELL:Int
   ┃  ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
   ┃  ┃  ┃
   ...
   ┃  ┃  ┃  │
   ┃  ┃  ┃  └─ 20 (leaf, pending)
   ┃  ┃  ┃      k: #access [ EVMOR , EVMOR W0:Int W1:Int ] ~> EVMOR W0:Int W1:Int ~> #pc [ EVMOR ]  ...
   ┃  ┃  ┃      pc: _PC_CELL:Int
   ┃  ┃  ┃      callDepth: _CALLDEPTH_CELL:Int
   ┃  ┃  ┃      statusCode: _STATUSCODE_CELL:StatusCode
   ┃  ┃  ┃
   ...
   ┃  ┃  ┃  │
   ┃  ┃  ┃  └─ 21 (leaf, pending)
   ┃  ┃  ┃      k: #end EVMC_OUT_OF_GAS ~> #access [ EVMOR , EVMOR W0:Int W1:Int ] ~> EVMOR W0:Int  ...
   ┃  ┃  ┃      pc: _PC_CELL:Int
   ┃  ┃  ┃      callDepth: _CALLDEPTH_CELL:Int
   ┃  ┃  ┃      statusCode: _STATUSCODE_CELL:StatusCode
   ┃  ┃  ┃
   ...
   ┗━━┓
      ...
      ┃  │
      ┃  ├─ 13 (split)
      ┃  │   k: #gas [ EVMOR , EVMOR W0:Int W2:Int ] ~> EVMOR W0:Int W2:Int ~> #pc [ EVMOR ] ~>  ...
      ┃  │   pc: _PC_CELL:Int
      ┃  │   callDepth: _CALLDEPTH_CELL:Int
      ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
      ┃  ┃
      ...
      ┗━━┓
         ...
         ┃  │
         ┃  ├─ 18 (split)
         ┃  │   k: #gas [ EVMOR , EVMOR W0:Int W3:Int ] ~> EVMOR W0:Int W3:Int ~> #pc [ EVMOR ] ~>  ...
         ┃  │   pc: _PC_CELL:Int
         ┃  │   callDepth: _CALLDEPTH_CELL:Int
         ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
         ┃  ┃
         ...
         ┗━━┓
            ...
            ┃  │
            ┃  └─ 25 (leaf, pending)
            ┃      k: #gas [ EVMOR , EVMOR W0:Int W4:Int ] ~> EVMOR W0:Int W4:Int ~> #pc [ EVMOR ] ~>  ...
            ┃      pc: _PC_CELL:Int
            ┃      callDepth: _CALLDEPTH_CELL:Int
            ┃      statusCode: _STATUSCODE_CELL:StatusCode
            ┃
...
module SUMMARY-EVMOR-SPEC
    
    
    rule [BASIC-BLOCK-5-TO-6]: <kevm>
           <k>
             ( #next [ EVMOR ] ~> .K => #exec [ EVMOR ]
             ~> #pc [ EVMOR ] )
             ~> __K_CELL
           </k>
           <ethereum>
    ...
    rule [BASIC-BLOCK-11-TO-17]: <kevm>
           <k>
             ( #gas [ EVMOR , EVMOR W0:Int W1:Int ] ~> .K => Gverylow < _SCHEDULE_CELL:Schedule >
             ~> #deductGas
             ~> #access [ EVMOR , EVMOR W0:Int W1:Int ] )
             ~> EVMOR W0:Int W1:Int
             ~> #pc [ EVMOR ]
             ~> __K_CELL
           </k>
    ...
    rule [BASIC-BLOCK-15-TO-27]: <kevm>
           <k>
             ( #gas [ EVMOR , EVMOR W0:Int W2:Int ] ~> .K => Gverylow < _SCHEDULE_CELL:Schedule >
             ~> #deductGas
             ~> #access [ EVMOR , EVMOR W0:Int W2:Int ] )
             ~> EVMOR W0:Int W2:Int
             ~> #pc [ EVMOR ]
             ~> __K_CELL
           </k>
