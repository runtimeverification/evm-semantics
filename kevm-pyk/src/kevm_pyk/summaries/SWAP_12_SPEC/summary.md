...
┣━━┓ subst: .Subst
┃  ┃ constraint:
┃  ┃     #sizeWordStack ( _WS:WordStack , 12 ) <Int 13
┃  │
┃  ├─ 3
┃  │   k: #next [ SWAP ( 12 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
┃  ┃     13 <=Int #sizeWordStack ( _WS:WordStack , 12 )
┃  │
┃  ├─ 16
┃  │   k: #next [ SWAP ( 12 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
    ...
    rule [BASIC-BLOCK-16-TO-13]: <kevm>
           ...
           <ethereum>
             <evm>
               <callState>
                 <wordStack>
                   ( ( _W0:Int => _WS:WordStack [ 0 ] ) : ( __W1 : ( __W2 : ( __W3 : ( __W4 : ( __W5 : ( __W6 : ( __W7 : ( __W8 : ( __W9 : ( __W10 : ( __W11 : ( _WS:WordStack => _WS:WordStack [ 0 := _W0:Int ] ) ) ) ) ) ) ) ) ) ) ) ) )
                 </wordStack>
                 <pc>
