...
module SUMMARY-JUMPDEST-SPEC
    ...
    rule [BASIC-BLOCK-13-TO-15]: <kevm>
      ...
      requires ( __USEGAS_CELL
       ...
       andBool ( _GAS_CELL:Gas <Gas Gjumpdest < _SCHEDULE_CELL:Schedule >
               ))))
      [priority(20), label(BASIC-BLOCK-13-TO-15)]
    
    rule [BASIC-BLOCK-17-TO-10]: <kevm>
           <k>
             ( #next [ JUMPDEST ] ~> .K => #gas [ JUMPDEST , JUMPDEST ]
             ~> JUMPDEST
             ~> #pc [ JUMPDEST ] )
             ~> __K_CELL
           </k>
    ...
    rule [BASIC-BLOCK-16-TO-11]: <kevm>
           <k>
             ( #next [ JUMPDEST ] ~> .K => Gjumpdest < _SCHEDULE_CELL:Schedule >
             ~> #deductGas
             ~> #access [ JUMPDEST , JUMPDEST ]
             ~> JUMPDEST
             ~> #pc [ JUMPDEST ] )
