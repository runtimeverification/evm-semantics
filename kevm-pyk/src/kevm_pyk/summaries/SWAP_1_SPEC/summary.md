...
┣━━┓ subst: .Subst
┃  ┃ constraint:
┃  ┃     #sizeWordStack ( _WS:WordStack , 1 ) <Int 2
┃  │
┃  ├─ 3
┃  │   k: #next [ SWAP ( 1 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
┃  ┃     2 <=Int #sizeWordStack ( _WS:WordStack , 1 )
┃  │
┃  ├─ 16
┃  │   k: #next [ SWAP ( 1 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
module SUMMARY-SWAP-1-SPEC
    ...
    rule [BASIC-BLOCK-3-TO-8]: <kevm>
      ...
      requires #sizeWordStack ( _WS:WordStack , 1 ) <Int 2
    ...
    rule [BASIC-BLOCK-16-TO-13]: <kevm>
           ...
           <ethereum>
             <evm>
               <callState>
                 <wordStack>
                   ( ( _W0:Int => _WS:WordStack [ 0 ] ) : ( _WS:WordStack => _WS:WordStack [ 0 := _W0:Int ] ) )
                 </wordStack>
                 <pc>
      ...
      requires ( ( notBool _USEGAS_CELL:Bool )
       andBool ( 2 <=Int #sizeWordStack ( _WS:WordStack , 1 )
               ))
