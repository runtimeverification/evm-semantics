...
┃  │  (7 steps)
┃  ├─ 14
┃  │   k: Gbase < _SCHEDULE_CELL:Schedule > ~> #deductGas ~> #access [ CALLER , CALLER ] ~ ...
┃  │   pc: _PC_CELL:Int
┃  │   callDepth: _CALLDEPTH_CELL:Int
┃  │   statusCode: _STATUSCODE_CELL:StatusCode
┃  ┃
...
┃  ┃  │
┃  ┃  ├─ 15
┃  ┃  │   k: #access [ CALLER , CALLER ] ~> CALLER ~> #pc [ CALLER ] ~> _K_CELL:K
┃  ┃  │   pc: _PC_CELL:Int
┃  ┃  │   callDepth: _CALLDEPTH_CELL:Int
┃  ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
┃  ┃  │
...
┃  ┃  │
┃  ┃  ├─ 16
┃  ┃  │   k: #end EVMC_OUT_OF_GAS ~> #access [ CALLER , CALLER ] ~> CALLER ~> #pc [ CALLER ]  ...
┃  ┃  │   pc: _PC_CELL:Int
┃  ┃  │   callDepth: _CALLDEPTH_CELL:Int
┃  ┃  │   statusCode: _STATUSCODE_CELL:StatusCode
┃  ┃  │
...
module SUMMARY-CALLER-SPEC
    ...
    rule [BASIC-BLOCK-22-TO-14]: <kevm>
           <k>
             ( #next [ CALLER ] ~> .K => Gbase < _SCHEDULE_CELL:Schedule >
             ~> #deductGas
             ~> #access [ CALLER , CALLER ]
             ~> CALLER
             ~> #pc [ CALLER ] )
