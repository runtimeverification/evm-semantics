...
┣━━┓ subst: .Subst
┃  ┃ constraint:
┃  ┃     #sizeWordStack ( _WS:WordStack , 16 ) <Int 17
┃  │
┃  ├─ 3
┃  │   k: #next [ SWAP ( 16 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
┃  ┃     17 <=Int #sizeWordStack ( _WS:WordStack , 16 )
┃  │
┃  ├─ 16
┃  │   k: #next [ SWAP ( 16 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
module SUMMARY-SWAP-16-SPEC
    ...
    rule [BASIC-BLOCK-3-TO-8]: <kevm>
      ...
      requires #sizeWordStack ( _WS:WordStack , 16 ) <Int 17
    ...
    rule [BASIC-BLOCK-16-TO-13]: <kevm>
           ...
           <ethereum>
             <evm>
               <callState>
                 <wordStack>
                   ( ( _W0:Int => _WS:WordStack [ 0 ] ) : ( __W1 : ( __W2 : ( __W3 : ( __W4 : ( __W5 : ( __W6 : ( __W7 : ( __W8 : ( __W9 : ( __W10 : ( __W11 : ( __W12 : ( __W13 : ( __W14 : ( __W15 : ( _WS:WordStack => _WS:WordStack [ 0 := _W0:Int ] ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
                 </wordStack>
                 <pc>
      ...
      requires ( ( notBool _USEGAS_CELL:Bool )
       andBool ( 17 <=Int #sizeWordStack ( _WS:WordStack , 16 )
               ))
