...
┣━━┓ subst: .Subst
┃  ┃ constraint:
┃  ┃     #sizeWordStack ( _WS:WordStack , 2 ) <Int 3
┃  │
┃  ├─ 3
┃  │   k: #next [ SWAP ( 2 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
┃  ┃     3 <=Int #sizeWordStack ( _WS:WordStack , 2 )
┃  │
┃  ├─ 16
┃  │   k: #next [ SWAP ( 2 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
module SUMMARY-SWAP-2-SPEC
    ...
    rule [BASIC-BLOCK-3-TO-8]: <kevm>
      ...
      requires #sizeWordStack ( _WS:WordStack , 2 ) <Int 3
    ...
    rule [BASIC-BLOCK-16-TO-13]: <kevm>
           ...
           <ethereum>
             <evm>
               <callState>
                 <wordStack>
                   ( ( _W0:Int => _WS:WordStack [ 0 ] ) : ( __W1 : ( _WS:WordStack => _WS:WordStack [ 0 := _W0:Int ] ) ) )
                 </wordStack>
                 <pc>
      ...
      requires ( ( notBool _USEGAS_CELL:Bool )
       andBool ( 3 <=Int #sizeWordStack ( _WS:WordStack , 2 )
               ))
