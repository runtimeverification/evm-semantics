...
┣━━┓ subst: .Subst
┃  ┃ constraint:
┃  ┃     1023 <Int #sizeWordStack ( _WS:WordStack , 1 )
┃  │
┃  ├─ 3
┃  │   k: #next [ DUP ( 1 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
┃  ┃     ( notBool #sizeWordStack ( _WS:WordStack , 1 ) <Int 1 )
┃  ┃     ( notBool 1023 <Int #sizeWordStack ( _WS:WordStack , 1 ) )
┃  │
┃  ├─ 16
┃  │   k: #next [ DUP ( 1 ) ] ~> _K_CELL:K
┃  │   pc: _PC_CELL:Int
...
module SUMMARY-DUP-1-SPEC
    ...
    rule [BASIC-BLOCK-3-TO-6]: <kevm>
      ...
      requires 1023 <Int #sizeWordStack ( _WS:WordStack , 1 )
    ...
    rule [BASIC-BLOCK-16-TO-13]: <kevm>
           ...
           <ethereum>
             <evm>
               <callState>
                 <wordStack>
                   ( _W0:Int : ( _WS:WordStack => ( _W0:Int : _WS:WordStack ) ) )
                 </wordStack>
                 <pc>
      ...
      requires ( ( notBool _USEGAS_CELL:Bool )
       ...
       andBool ( ( notBool 1023 <Int #sizeWordStack ( _WS:WordStack , 1 ) )
               )))
       ensures #sizeWordStack ( _WS:WordStack , 1 ) <=Int 1023
