...
these statements are semantically very diferent, with the former being equivalent to a simple = (the second
...
We now present reachability claims used for verificaton, one for each funtion in the ERC20 specification. 
...
TRANSFER represents the symbolic amonut to transfer, B1 and B2 are the starting balances of accounts 1 and
2, repsectively, and A1 is the allowance of account 1 (strictly smaller than the balance).
