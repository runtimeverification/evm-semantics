...
```{.k .standalone}
 ...
 // -------------------------------------
    ...
    rule <k> load "transaction" : { TXID : { "r" : TR:WordStack } } => . ... </k>
         <message> <msgID> TXID </msgID> <r> _ => TR </r> ... </message>

    rule <k> load "transaction" : { TXID : { "s" : TS:WordStack } } => . ... </k>
         <message> <msgID> TXID </msgID> <s> _ => TS </s> ... </message>
```
