...
TODO: Right now we have hardcoded `PushOp` and `StackOp` because we can't use
the set-inclusion method unless it is made aware that it should ignore the
argument given to these operators.
