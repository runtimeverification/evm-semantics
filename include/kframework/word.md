...
```k
    syntax Int ::= "minSInt8"        [macro]
                 ...
                 | "maxSInt96"       [alias]
                 | "minSInt104"      [macro]
                 | "minSInt104Word"  [macro]
                 | "maxSInt104"      [alias]
                 | "minSInt112"      [macro]
                 | "minSInt112Word"  [macro]
                 | "maxSInt112"      [alias]
                 | "minSInt120"      [macro]
                 | "minSInt120Word"  [macro]
                 | "maxSInt120"      [alias]
                 | "minSInt128"      [macro]
                 | "minSInt128Word"  [alias]
                 | "maxSInt128"      [alias]
                 | "minSInt136"      [macro]
                 | "minSInt136Word"  [macro]
                 | "maxSInt136"      [alias]
                 | "minSInt144"      [macro]
                 | "minSInt144Word"  [macro]
                 | "maxSInt144"      [alias]
                 | "minSInt152"      [macro]
                 | "minSInt152Word"  [macro]
                 | "maxSInt152"      [alias]
                 | "minSInt160"      [macro]
                 | "minSInt160Word"  [macro]
                 | "maxSInt160"      [alias]
                 | "minSInt168"      [macro]
                 | "minSInt168Word"  [macro]
                 | "maxSInt168"      [alias]
                 | "minSInt176"      [macro]
                 | "minSInt176Word"  [macro]
                 | "maxSInt176"      [alias]
                 | "minSInt184"      [macro]
                 | "minSInt184Word"  [macro]
                 | "maxSInt184"      [alias]
                 | "minSInt192"      [macro]
                 | "minSInt192Word"  [macro]
                 | "maxSInt192"      [alias]
                 | "minSInt200"      [macro]
                 | "minSInt200Word"  [macro]
                 | "maxSInt200"      [alias]
                 | "minSInt208"      [macro]
                 | "minSInt208Word"  [macro]
                 | "maxSInt208"      [alias]
                 | "minSInt216"      [macro]
                 | "minSInt216Word"  [macro]
                 | "maxSInt216"      [alias]
                 | "minSInt224"      [macro]
                 | "minSInt224Word"  [macro]
                 | "maxSInt224"      [alias]
                 | "minSInt232"      [macro]
                 | "minSInt232Word"  [macro]
                 | "maxSInt232"      [alias]
                 | "minSInt240"      [macro]
                 | "minSInt240Word"  [macro]
                 | "maxSInt240"      [alias]
                 | "minSInt248"      [macro]
                 | "minSInt248Word"  [macro]
                 | "maxSInt248"      [alias]
                 | "minSInt256"      [macro]
                 | "minSInt256Word"  [macro]
                 | "maxSInt256"      [alias]
                 | "minUInt8"        [macro]
                 | "maxUInt8"        [alias]
                 | "minUInt16"       [macro]
