...
```k
 ...
 // ----------------------------------------------------------------------------------
    ...
    rule [Csstore.new21]: Csstore(SCHED, NEW, CURR, ORIG) => Gsstoreset < SCHED >
      requires Ghasdirtysstore << SCHED >>
       andBool notBool ( CURR ==Int NEW orBool CURR =/=Int ORIG )
       andBool ORIG ==Int 0

    rule [Csstore.new22]: Csstore(SCHED, NEW, CURR, ORIG) => Gsstorereset < SCHED >
      requires Ghasdirtysstore << SCHED >>
       andBool notBool ( CURR ==Int NEW orBool CURR =/=Int ORIG )
       andBool ORIG =/=Int 0
    ...
    rule [Rsstore.new211]: Rsstore(SCHED, NEW, CURR, ORIG) => Rsstoreadd(SCHED, NEW, CURR, ORIG) -Int Rsstorededuct(SCHED, NEW, CURR, ORIG)
      requires Ghasdirtysstore << SCHED >>
       andBool CURR =/=Int NEW
       andBool CURR ==Int ORIG
       andBool NEW ==Int 0

    rule [Rsstore.new212]: Rsstore(SCHED, NEW, CURR, ORIG) => Rsstoreadd(SCHED, NEW, CURR, ORIG) -Int Rsstorededuct(SCHED, NEW, CURR, ORIG)
      requires Ghasdirtysstore << SCHED >>
       andBool CURR =/=Int NEW
       andBool ORIG =/=Int NEW
       andBool NEW ==Int 0

    rule [Rsstore.new3221]: Rsstore(SCHED, NEW, CURR, ORIG) => Rsstoreadd(SCHED, NEW, CURR, ORIG) -Int Rsstorededuct(SCHED, NEW, CURR, ORIG)
      requires Ghasdirtysstore << SCHED >>
       andBool CURR =/=Int NEW
       andBool CURR =/=Int ORIG
       andBool ( ORIG ==Int NEW orBool ( NEW =/=Int 0 andBool CURR ==Int 0 ) )

    rule [Rsstore.old1]: Rsstore(SCHED, NEW, CURR, ORIG) => 0
      requires notBool Ghasdirtysstore << SCHED >>
       andBool ( CURR ==Int 0 orBool NEW =/=Int 0 )

    rule [Rsstore.old2]: Rsstore(SCHED, NEW, CURR, ORIG) => Rsstoreclear < SCHED >
      requires notBool Ghasdirtysstore << SCHED >>
 ...
 // ----------------------------------------------------------------------
    ...
    rule Rsstoreadd(SCHED, NEW, CURR, ORIG) => Rsstoreclear < SCHED >
      requires Ghasdirtysstore << SCHED >>
       andBool CURR =/=Int NEW
       andBool NEW ==Int 0
