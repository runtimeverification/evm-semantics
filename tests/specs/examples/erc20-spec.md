...
```k
    claim (#bufStrict(32, #loc(KEVMERC20._allowances[OWNER]))) => (#buf(32, keccak(#buf(32, OWNER) +Bytes #buf(32, 1))))
...
```k
    claim [decimals]:
          ...
          <program>   #binRuntime(KEVMERC20)                         </program>
          <jumpDests> #computeValidJumpDests(#binRuntime(KEVMERC20)) </jumpDests>
          ...
          <callData>   KEVMERC20.decimals()               </callData>
          <k>          #execute => #halt ...          </k>
       ...
       requires DECIMALS_KEY ==Int #loc(KEVMERC20._decimals)
...
```k
    claim [totalSupply]:
          ...
          <callData>   KEVMERC20.totalSupply()               </callData>
          <k>          #execute => #halt ...             </k>
       ...
       requires TOTALSUPPLY_KEY ==Int #loc(KEVMERC20._totalSupply)
...
```k
    claim [approve.success]:
          ...
          <callData>   KEVMERC20.approve(SPENDER : address, AMOUNT : uint256) </callData>
          <k>          #execute => #halt ...        </k>
       ...
       requires ALLOWANCE_KEY ==Int #loc(KEVMERC20._allowances[OWNER][SPENDER])
